...
class App extends React.Component {
  ...
  render() {
    return (
      <div>
        <Container className="bg-purple-300 pt-8 rounded-t-3xl">
...
<header className="bg-purple-400  rounded-full ...">

<h1 class="font-sans ... text-center p-3 " > CRUD TASK </h1>
</header>

          {/* All Records */}
          <Row className="mt-5  p-8">
            <Table class="table-auto py-2 mt-8 " >
              <thead>
          ...
          <div className="mt-2 pt-3">
             <h1  class="flex justify-center ... font-sans ... text-center  p-3  bg-purple-400  rounded-full ... " >ADD OR EDIT DETAILS</h1>
          </div>
